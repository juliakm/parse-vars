    ...
    class MapVariables
    {
        ...
        public static void Mapper(string[] args)
        {
            ...
            foreach (string moniker in monikers)
            {
                ...
                //Grab a table and save the values as name and text
                foreach (var row in htmlDoc.DocumentNode.SelectNodes("//*[@id='main']//tr"))
                {
                    ...
                    if (nodes != null)
                    {
                        ...
                        // TODO: Update to retrieve actual text
                        ...
                        foreach (string varName in sortedVariables)
                        {
                            ...
                            foreach (string monikerVersion in monikers)
                            {
                                // If this variable contains an entry for this moniker, add it to the moniker string
                                if (varDetails.ContainsKey(monikerVersion))
                                {
                                    ...
                                    monikerVersionsSB.Append(monikerVersion);
                                }
                            }
                            ...
                            foreach (string monikerVersion in monikers)
                            {
...

                                {
                                    ...
                                    //Console.WriteLine("::: moniker range=\"{0}\"", monikerVersion);
                                    //Console.WriteLine();
                                    //Console.WriteLine(varDetails[monikerVersion]);
                                    //Console.WriteLine();
